##This Algorithm is to model a random forest to predict Customer churning status from an MTN nigeria data
import pandas as pd
...
print('Data Prepared for Machine Learning Algorithm: Decision Tree')
print(data.head())
##MACHINE LEARNING ALGORITM DEPLOYED HERE
